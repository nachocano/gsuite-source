...
import (
	...
	"github.com/nachocano/gsuite-source/pkg/client/clientset/versioned/scheme"
...
func (c *SourcesV1alpha1Client) SheetsSources(namespace string) SheetsSourceInterface {
	return newSheetsSources(c, namespace)
}
